...
// qv2Version is the only supported qURL artifact version. The version is pinned;
// there is no negotiation from the payload.
const qv2Version = 2

// qv2FragmentPrefix is the literal first dot-token of a qURL v2 fragment.
const qv2FragmentPrefix = "qv2"

// qv2Issuer is the expected value of the claims `iss` field.
const qv2Issuer = "qurl-service"
