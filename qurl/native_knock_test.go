...
// TestEmptyBodyRepliesRemainRejected pins the application-level requirement
// that a bodyless authenticated reply cannot be interpreted as an admission.
func TestEmptyBodyRepliesRemainRejected(t *testing.T) {
	...
	// It must never read as a successful knock.
