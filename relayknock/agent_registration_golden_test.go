...
// The bytes come directly from qurl-conformance's go:embed accessor and their
// released module version is pinned by go.mod/go.sum. Do not copy the artifact
// into this repository or edit an assertion to make a mismatch pass: a mismatch
// means this port drifted from the reference server wire format.
